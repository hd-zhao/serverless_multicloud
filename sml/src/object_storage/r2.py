...
def input_credential(credential):
    ...
    s3_client = boto3.client('s3',
                            endpoint_url = 'https://'+aws_credential["cloudflare"]['Account ID']+'.r2.cloudflarestorage.com',  
                            aws_access_key_id = aws_credential["cloudflare"]['Access key ID'],
                            aws_secret_access_key = aws_credential["cloudflare"]['Secret access key'],
                            region_name = "auto"
                            )
    return s3_client
